        ...
        <div role="document" class="modal-dialog">
            <div class="modal-content modal-lg">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">{{ localization.trans('row_settings_modal.title') }}</h4>
                </div>
                    ...
                    <div class="col-md-6">
                        <fieldset class="content-group">
                            <legend class="text-bold">
                                ...
                                {{ localization.trans('row_settings_modal.legend') }}
                            </legend>

                            <!-- Class -->
                            <div class="form-group">
                                <label for="input-row-class">
                                    {{ localization.trans('row_settings_modal.labels.class') }}
                                </label>
                                <input id="input-row-class" type="text" class="form-control" v-model="form.class">
                            </div>

                            <!-- ID -->
                            <div class="form-group">
                                <label for="input-row-id">
                                    {{ localization.trans('row_settings_modal.labels.id') }}
                                </label>
                                <input id="input-row-id" type="text" class="form-control" v-model="form.id">
                            </div>

                            <!-- Tags -->
                            <div class="form-group">
                                <label for="input-row-tag">
                                    {{ localization.trans('row_settings_modal.labels.tag') }}
                                </label>
                                <select id="input-row-tag" v-model="form.tag" class="form-control">
                            ...
                            <!-- Background color -->
                            <div class="form-group">
                                <label for="input-row-bg">
                                    {{ localization.trans('row_settings_modal.labels.bg') }}
                                </label>
                                <input id="input-row-bg" type="hidden">
                            </div>
                            ...
                            <div class="form-group">
                                <div class="checkbox">
                                    <label>
                                        <input id="input-row-active"
                                               type="checkbox"
                                               class="styled"
                                        >
                                        {{ localization.trans('row_settings_modal.labels.active') }}
                                    </label>
                                </div>
                            </div>
                        </fieldset>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            this.formInputs.$bg = $('#input-row-bg');
            this.formInputs.$bg.on('change', (e, value) => {
                this.form.bg = value || null;
            }).colorPicker();

            this.formInputs.$active = $('#input-row-active');
