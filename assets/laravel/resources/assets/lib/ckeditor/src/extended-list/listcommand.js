...
import ListCommandSuper from '@ckeditor/ckeditor5-list/src/listcommand';
 ...
 *
 */
export default class ListCommand extends ListCommandSuper {
	/**
	...
	constructor( editor, type ) {
		 ...
		 *
		 * @readonly
		 * @member {'numbered'|'bulleted'|object}
		 */
