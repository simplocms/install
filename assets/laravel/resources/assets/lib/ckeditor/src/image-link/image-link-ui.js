...
/**
 * @module image-link/image-link-ui
 */
...
import { isImageWidgetSelected } from '@ckeditor/ckeditor5-image/src/image/utils';
 ...
 */
export default class ImageLinkUI extends Plugin {
	/**
	 * @inheritDoc
	 */
	static get requires() {
	...
	_createButton() {
		...
		editor.ui.componentFactory.add( 'imageLink', locale => {
			...
			this.listenTo( button, 'execute', () => this._showForm() );
